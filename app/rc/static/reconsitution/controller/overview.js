...
app.controller("resourceDashboardCtl",function($scope,$http,EventBus,SAlert){
...
app.controller("resourceChartCtl",function($scope,$http,EventBus,SAlert){
...
app.controller("serverCtl",function($scope,$http,EventBus,SAlert){
...
app.controller("alarmCtl",function($scope,$http,EventBus,SAlert){
...
app.controller("operationCtl",function($scope,$http,EventBus,SAlert){
