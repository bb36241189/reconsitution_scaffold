...
app.controller("keypairController",function($scope,$http,EventBus,SAlert){
...
app.controller("create_keypair",function($scope,$http,EventBus,SAlert){
...
app.controller("import_keypair",function($scope,$http,EventBus,SAlert){
...
app.controller("delete_keypair",function($scope,$http,EventBus,SAlert){
