...
app.controller("pool",function($scope,$http,EventBus,SAlert){
    var path = project_url + "/lb/pools";
    var pool_transfer = {
        "ACTIVE":"可用",
        "INACTIVE":"不可用"
    };
...
app.controller("pool_detail",function($scope,$http,EventBus,SAlert){
...
app.controller("member",function($scope,$http,EventBus,SAlert){
...
app.controller("monitor1",function($scope,$http,EventBus,SAlert){
...
app.controller("create_pool_modal",function($scope,$http,EventBus,SAlert){
...
app.controller("edit_pool",function($scope,$http,EventBus,SAlert){
...
app.controller("delete_pool",function($scope,$http,EventBus,SAlert){
...
app.controller("create_member",function($scope,$http,EventBus,SAlert){
...
app.controller("edit_member",function($scope,$http,EventBus,SAlert){
...
app.controller("delete_member",function($scope,$http,EventBus,SAlert){
...
app.controller("create_monitor",function($scope,$http,EventBus,SAlert){
...
app.controller("edit_monitor",function($scope,$http,EventBus,SAlert){
...
app.controller("delete_monitor",function($scope,$http,EventBus,SAlert){
...
app.controller("create_vip",function($scope,$http,EventBus,SAlert){
...
app.controller("edit_vip",function($scope,$http,EventBus,SAlert){
...
app.controller("delete_vip",function($scope,$http,EventBus,SAlert){
...
app.controller("link_control",function($scope,$http,EventBus,SAlert){
...
app.controller("unlink_control",function($scope,$http,EventBus,SAlert){
...
app.controller("floating_ip",function($scope,$http,EventBus){
