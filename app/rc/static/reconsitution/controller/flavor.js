...
app.controller("flavor_list_ctl",function($scope,$http,EventBus,SAlert){
...
app.controller("modal_create_flavor",function($scope,$http,EventBus,SAlert){
...
// app.controller("modal_edit_flavor",function($scope,$http,EventBus){
//     $scope.showModal = function(){
...
app.controller("delete_flavor_modal",function($scope,$http,EventBus,SAlert){
