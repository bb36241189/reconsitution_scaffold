...
app.factory('OriginApp',[function () {
     // IE mode
    var isRTL = false;
    var isIE8 = false;
    var isIE9 = false;
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (height >= content.height()) {
                if(content.attr("type") != "out_container"){
    ...
    var handleSidebarMenu2 = function(){
        jQuery('.page-sidebar').on('mouseenter', 'li > a', function (e) {
            var parent = $(this).parent().parent();
            parent.children('li.open').children('.sub-menu').animate({left:"120px",opacity:0},100,function(){$(this).css({display:"none"});});
            parent.children('li.open').removeClass('open');

            var sub = jQuery(this).next();
            jQuery('.arrow', jQuery(this)).addClass("open");
                    jQuery(this).parent().addClass("open");
                    sub.css({display:"block"}).animate({left:"85px",opacity:1},100);
            e.preventDefault();
        });
    };
    ...
    var handleSidebarMenu1 = function(){
        /*
        $('.page-sidebar>ul>li').hover(function(){
        ...
        */
        ...
        $('.page-sidebar>ul>li').hover(function(){
            $(this).children('.sub-menu').css({display:"block"}).animate({left:"85px",opacity:1},100);
        },function(){
            $(this).children('.sub-menu').animate({left:"150px",opacity:0},100,function(){$(this).css({display:"none"});});
        });
    }
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
                ...
                retObj.blockUI(pageContent, false);

                $.post(url, {}, function (res) {
                    retObj.unblockUI(pageContent);
                    pageContentBody.html(res);
                    retObj.fixContentHeight(); // fix content height
                    retObj.initUniform(); // initialize uniform elements
                });
        });
    }
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar').on('keypress', '.sidebar-search input', function (e) {
            if (e.which == 13) {
                window.location.href = project_url + "extra_search.html";
    ...
    var handleTooltips = function () {
        if (retObj.isTouchDevice()) { // if touch device, some tooltips can be skipped in order to not conflict with click events
    ...
    angular.extend(retObj,{
        ...
        init: function () {
            ...
            handleSidebarMenu1(); // handles main menu
            ...
            retObj.addResponsiveHandler(handleChoosenSelect); // reinitiate chosen dropdown on main content resize. disable this line if you don't really use chosen dropdowns.
        },
