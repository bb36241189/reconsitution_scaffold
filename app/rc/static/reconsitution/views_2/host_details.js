 ...
 */
app.controller('hostDetailController',['$scope','$http','$timeout','host_detailService', function ($scope,$http,$timeout,host_detailService) {
    var state_map = {
        'up': "运行中",
        'down': "停止"
    };
    ...
    function render_sample_data(chart_name, meter_item, resource_name, start, end) {
       /* console.debug("Enter render_sample_data function, and chartName", chart_name, "meter_item", meter_item,
        ...
        var path = project_url + '/hosts-telemetry';
