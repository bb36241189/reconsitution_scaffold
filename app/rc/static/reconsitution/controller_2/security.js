app.controller('SecurityController',['$scope','$http','SAlert','PermitStatus',function ($scope,$http,SAlert,PermitStatus) {
    $(function () {
        get_all_securities();
        disabled_button();
    ...
    function get_all_securities() {
        $.ajax({
            type: "GET",
            url: project_url + "/security-groups",
            dataType: "json",
            headers:{
            ...
            success: function (data) {
                //render_security_list(data);
                security_table_pagination(data.security_groups);
    ...
    function init_security_detail(security_id) {
        $.ajax({
            ...
            success: function (data) {
                render_detail_table(data, security_id);
            },
            error: function(e){
                //console.log(e);
                SAlert.showError(e)
    ...
    function delete_securities() {
        ...
        for (var i = 0; i < $securities_td.length; i++) {
            ...
            $.ajax({
                ...
                success: delete_relevant_row(security_id),
                error: function(e){
                    //console.log(e);
                    SAlert.showError(e)
                }
    ...
    function edit_security() {
        ...
        if (request_data.name || request_data.description) {
            ...
            $.ajax({
                type: "PUT",
                url: project_url + "/security-groups/" + security_id,
    ...
    function create_security() {
        ...
        if (name) {
            ...
            $.ajax({
                ...
                success: function () {
                    //console.log("Request send success!");
                    //$("#create_security_modal").modal('hide');
                    location.reload();
                },
                error: function (e) {
                    //alert("创建安全组请求失败！")
    ...
    function delete_rule() {
        ...
        for (var i = 0; i < $rules_tr.length; i++) {
            ...
            $.ajax({
                ...
                success: delete_relevant_row(rule_id),
                error: function(e){
                    //console.log(e);
                    SAlert.showError(e)
                }
    ...
    function create_security_rule(request_data) {
        ...
        $.ajax({
            type: "POST",
            url: project_url + "/security-group-rules",
            data: JSON.stringify(request_data),
            headers:{
                "RC-Token": $.cookie("token_id")
            },
