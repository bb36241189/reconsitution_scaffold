...
app.controller("volumeTypeCtl",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("create_volumeType_modal",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("delete_volumeType",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("qosSpec",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("create_qosSpec_modal",function($scope,$http,EventBus,SAlert,PermitStatus){
    $scope.showModal = function(){
...
app.controller("delete_QosSpec",function($scope,$http,EventBus,SAlert,PermitStatus){
    $scope.clickDelete = function(){
...
app.controller("link_qos_modal",function($scope,$http,EventBus,SAlert,PermitStatus){
