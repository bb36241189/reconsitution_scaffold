...
app.controller('NetworkController',['$scope','$http','SAlert','PermitStatus',function ($scope,$http,SAlert,PermitStatus) {
    $(function (){
    ...
    function init_network_table(search){
        $.ajax({
            type: "GET",
            url: project_url + "/networks"+"?name="+search,
            async: true,
            dataType: "json",
            headers:{
    ...
    function get_qos_policy(op_type) {
        $.ajax({
            ...
            success: function (data) {
                if ('create' == op_type){
                    render_qos_policy(data);
                }else if('update' == op_type){
                    render_qos_policy_update(data);
                }
    ...
    function click_submit_delete_network(){
        $("#submit_delete_network").click(function () {
            ...
            $.ajax({
                type:"DELETE",
                url:project_url + "/network/"+network_id,
                headers: {
                    "RC-Token": $.cookie("token_id")
                },
                success:function(msg){
    ...
    function get_network_detail_data(network_id){
        ...
        $.ajax({
            ...
            success: function(data){
                if (data) {
                    //console.log(data);
                    var network_data = JSON.parse(data);
                    render_detail_data(network_data);
                    init_edit_network_form(network_data);
                }
            },
            error: function(e){
                //console.log(e);
