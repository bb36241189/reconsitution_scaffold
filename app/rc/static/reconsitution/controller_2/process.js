...
app.controller('ProcessController',['$scope','$http','SAlert','PermitStatus',function ($scope,$http,SAlert,PermitStatus) {
    var status_map = {
        cancel: {
    ...
    */
    ...
    function getDonelist(){
        $.ajax({
            type: "GET",
            url: project_url + "/requests_related",
            dataType: "json",
            headers: {
                "RC-Token": $.cookie("token_id")
            },
