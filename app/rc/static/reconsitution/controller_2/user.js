...
app.controller('UserController',['$scope','$http','SAlert','PermitStatus',function ($scope,$http,SAlert,PermitStatus) {
    $(function (){
        set_navigator();
        disabled_button();
        init_user_table("");
    ...
    function init_user_table(search){
        $.ajax({
            type: "GET",
            url: project_url + "/users"+"?user_name="+search,
            async: true,
            dataType: "json",
            headers:{
    ...
    function init_create_department(){
        $.ajax({
            ...
            success: function(data){
                ...
                render_create_department(data.departments);
            },
            error: function(e){
                //console.log(e);
                SAlert.showError(e);
    ...
    function init_edit_department(){
        $.ajax({
            ...
            success: function(data){
                //console.log(data.departments);
                render_edit_department(data.departments);
            },
            error: function(e){
                //console.log(e);
                SAlert.showError(e);
    ...
    function check_user_exist(key,value){
        ...
        $.ajax({
            type: "GET",
            url: project_url + "/user?"+key+"="+value,
            async: false,
            dataType: "json",
            headers:{
                "RC-Token": $.cookie("token_id")
