...
app.controller("policies_list_ctl",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("modal_create_network_qos",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("modal_edit_network_qos",function($scope,$http,EventBus,SAlert,PermitStatus){
    $scope.showModal = function(){
...
app.controller("delete_network_qos_modal",function($scope,$http,EventBus,SAlert,PermitStatus){
