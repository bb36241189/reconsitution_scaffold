...
app.controller("main_list",function($scope,$http,$uibModal,NgTableParams,ipCookie,SAlert,PermitStatus){
    //局部变量
    var _col_length = 3;
...
//callback为传参
app.controller("modal_create",function($scope,$http,$uibModalInstance,callback,SAlert,PermitStatus){
...
app.controller("modal_edit",function($scope,$http,$uibModalInstance,origin_data,callback,SAlert,PermitStatus){
...
app.controller("modal_delete",function($scope,$http,$uibModalInstance,origin_data,callback,SAlert,PermitStatus){
    $scope.id = origin_data.id;
...
app.controller("modal_bind",function($scope,$http,$uibModalInstance,origin_data,callback,SAlert,PermitStatus){
    $scope.id = origin_data.id;
    $scope.hosts_add = [];
    $scope.hosts_pool = [];
    $http({
