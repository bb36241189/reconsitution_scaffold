...
app.controller("keypairController",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("create_keypair",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("import_keypair",function($scope,$http,EventBus,SAlert,PermitStatus){
...
app.controller("delete_keypair",function($scope,$http,EventBus,SAlert,PermitStatus){
