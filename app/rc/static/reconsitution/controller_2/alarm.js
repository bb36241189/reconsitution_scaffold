...
app.controller('AlarmController',['$scope','$http','SAlert','PermitStatus',function ($scope,$http,SAlert,PermitStatus) {
    $(function(){
        initInputs();
        get_Event_list();
        get_Volume_list();
    ...
    function get_Volume_list(){
        ...
        $.ajax({
            type: "GET",
            url: project_url + "/storage_alarms",
            data:data,
            dataType: "json",
            headers:{
                "RC-Token": $.cookie("token_id")
