app.controller('StorageController',['$scope','$http','$timeout','SAlert','PermitStatus',function ($scope,$http,$timeout,SAlert,PermitStatus) {
    ...
    function get_all_pools(search_name) {
        $.ajax({
            type: "GET",
            url: project_url + "/storage_pools"+"?name="+search_name,
            dataType: "json",
            headers:{
