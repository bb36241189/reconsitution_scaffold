...
app.controller("policies_list_ctl",function($scope,$http,EventBus,SAlert){
...
app.controller("modal_create_network_qos",function($scope,$http,EventBus,SAlert){
...
app.controller("modal_edit_network_qos",function($scope,$http,EventBus,SAlert){
    $scope.showModal = function(){
...
app.controller("delete_network_qos_modal",function($scope,$http,EventBus,SAlert){
