app.controller('imageController',['$scope','SAlert','PermitStatus','PermitStatus',function ($scope,SAlert,PermitStatus,PermitStatus) {
    $scope.data = {
    ...
    function get_all_images(search_name) {
        $.ajax({
            type: "GET",
            url: project_url + "/images" + "?name=" + search_name,
            dataType: "json",
            headers: {
    ...
    function upload_image_callback(params) {
        ...
        $.ajax({
            type: "POST",
            url: path = project_url + "/file_image",
            data: JSON.stringify(params),
            headers: {
                "RC-Token": $.cookie("token_id")
            },
    ...
    */
    ...
    function register_download_image(){
        $("#download_confirm_button").off("click").on("click", function(){
            ...
            $.download(project_url + "/download_image/" + image_id, 'get');
