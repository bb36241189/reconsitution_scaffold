app.controller('serverController',['$scope','SAlert','$q','PermitStatus','ServerService','UtilService','PermitStatus',function ($scope,SAlert,$q,PermitStatus,ServerService,UtilService,PermitStatus) {
